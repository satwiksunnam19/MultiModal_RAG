...
from rag import EmbedData, QdrantVDB_QB, Retriever, RAG
...
# """.format(base64.b64encode(open("assets/deep-seek.png", "rb").read()).decode()))
    st.markdown("""
    # Multimodal RAG powered by <img src="data:image/png;base64,{}" width="220" style="vertical-align: -0px;">""".format(base64.b64encode(open("/Users/satwiksunnam/Downloads/DL_Experiments/Qwen_MultiModal_RAG/qwen.png", "rb").read()).decode()), unsafe_allow_html=True)
